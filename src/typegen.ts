...
export type ConfigNames = 'adufr/global-ignores' | 'adufr/gitignore' | 'adufr/js/recommended' | 'adufr/js' | 'adufr/comments/recommended' | 'adufr/comments' | 'adufr/imports' | 'adufr/unicorn' | 'adufr/node' | 'adufr/jsdoc' | 'adufr/regexp' | 'adufr/de-morgan' | 'adufr/typescript__typescript-eslint/base' | 'adufr/typescript__typescript-eslint/eslint-recommended' | 'adufr/typescript__typescript-eslint/recommended' | 'adufr/typescript' | 'adufr/typescript/dts-rules' | 'adufr/typescript/cjs-rules' | 'adufr/sort/imports' | 'adufr/markdown/recommended/plugin' | 'adufr/markdown/recommended/processor' | 'adufr/markdown/recommended/code-blocks' | 'adufr/markdown-rules' | 'sxzz/yaml/setup' | 'adufr/yaml/rules' | 'adufr/json' | 'adufr/sort/package.json' | 'adufr/sort/tsconfig' | 'sxzz/sort/pnpm-workspace' | 'adufr/vue/typescript__typescript-eslint/base' | 'adufr/vue/typescript__typescript-eslint/eslint-recommended' | 'adufr/vue/typescript__typescript-eslint/recommended' | 'adufr/vue/typescript' | 'adufr/vue' | 'adufr/vue/reactivity-transform' | 'adufr/unocss' | 'adufr/prettier' | 'adufr/command' | 'sxzz/pnpm/rules' | 'adufr/special/cli' | 'adufr/special/tests' | 'adufr/special/allow-default-export'
